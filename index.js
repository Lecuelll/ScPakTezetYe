...
const { imageToWebp, videoToWebp, writeExifImg, writeExifVid } = require('./zenbase/lib/exif')
const { smsg, isUrl, generateMessageTag, getBuffer, getSizeMedia, fetchJson, await, sleep } = require('./zenbase/lib/myfunc')
//=================================================//
var low
try {
low = require('lowdb')
} catch (e) {
low = require('./zenbase/lib/lowdb')}
//=================================================//
const { Low, JSONFile } = low
const mongoDB = require('./zenbase/lib/mongoDB')
//=================================================//
...
new mongoDB(opts['db']) :
new JSONFile(`zenbase/zenu/database.json`)
)
...
let buttonMessage = {
document: fs.readFileSync('./zenbase/lib/tes.xlsx'),
mimetype: feler,
...
let { writeExif } = require('./zenbase/lib/exif')
...
ext: '.bin'}
filename = path.join(__filename, '../zenbase/zenu/' + new Date * 1 + '.' + type.ext)
...
if (options.asDocument) type = 'document'
if (options.asSticker || /webp/.test(mime)) {
let { writeExif } = require('./zenbase/lib/sticker.js')
let media = { mimetype: mime, data }
